...
namespace NGS.SuperLevelOptimizer
{
    ...
    public class TexturePacker
    {
        ...
        private void CreateCopyOfMeshes(Renderer[] renderers, string folderPath)
        {
            for (int i = 0; i < renderers.Length; i++)
            {
                ...
                var instance = (Mesh)Object.Instantiate(filter.sharedMesh);

                filter.sharedMesh = MaterialsWorker.SaveAssetToFile(instance, folderPath + "Meshes/", "mesh");
            }
        }
    }
    ...
    public static class MaterialsWorker
    {
        ...
        public static Texture2D[] GetTextures(Material material, ref string[] textureNames)
        {
            ...
            for (int i = 0; i < count; i++)
            {
#if UNITY_5_4_OR_NEWER || UNITY_5_4 || UNITY_5_5 || UNITY_5_6 || UNITY_5_7 || UNITY_5_8 || UNITY_5_9 || UNITY_2017 || UNITY_2018 || UNITY_2019
